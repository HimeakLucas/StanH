...
# Diferencas: amostra disjunta, JSON proprio, e NAO regenera a figura do artigo
# (a figura atual mistura curvas STanH da amostra antiga; so muda quando o W5 mudar).
set -u
